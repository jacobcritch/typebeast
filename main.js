...
function GameLoop() {
  ...
  if (
    input === gameTextArr[0] + " " ||
    (input === gameTextArrOrg[gameTextArrLength - 1] && // If input === prompted word
    ...
    if (wordCount === gameTextArrLength) {
      ...
      document.getElementById("best").innerHTML =
        "Your best: " + best.toString().substr(0, 5);
      document.getElementById("average").innerHTML =
        "Your average: " + avg.toString().substr(0, 5);
...
function displayScoreEntryForm() {
  ...
  lbInput.setAttribute(
    "onsubmit",
    "scoreFormSubmit(this.name.value); return false;"
  );
  lbInput.innerHTML =
  ...
  lbInputLabel.innerHTML =
    "<h5>Enter your name to submit your best score for the leaderboard:</h5>";
